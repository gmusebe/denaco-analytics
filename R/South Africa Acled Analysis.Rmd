...
count_location <- as.data.frame(table(df$location))
matching_rows <- df_copy$location %in% count_location$Var1
df_copy$count_location <- count_location$Freq[matching_rows]
```
